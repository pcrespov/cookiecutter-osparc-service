...
do
    ...
    export DOCKER_ETAG=$(./docker-registry-curl.bash -I -H "Accept: application/vnd.docker.distribution.manifest.v2+json" -X GET "https://${DOCKER_REGISTRY}/v2/${DOCKER_PROJECT}/manifests/${DOCKER_TAG}" | egrep -e "Docker-Content-Digest: " | cut -d " " -f2 | tr -d \" | sed 's/\r//')
